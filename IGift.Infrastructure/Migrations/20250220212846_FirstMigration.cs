        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChatHistories_Users_FromUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contracts_Users_IdUser2",
                        column: x => x.IdUser2,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperacionesIntercambio", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OperacionesIntercambio_Users_IdUser2",
                        column: x => x.IdUser2,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperacionesIntercambio_IdUser2",
